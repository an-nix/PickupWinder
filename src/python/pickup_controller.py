"""Application-level controller for PickupWinder.

This module exposes high-level actions on top of the low-level daemon
JSON protocol. It keeps application logic separate from socket transport.
"""

from typing import Dict, Optional

# Re-export from packaged location for backwards compatibility
from pickup.pickup_controller import PickupController as _PickupController


class PickupController(_PickupController):
    """Backward-compatible alias for pickup.pickup_controller.PickupController."""
    pass

__all__ = ["PickupController"]
